...
let g:colors_name='pink_pony_club'

let s:black           = {"gui": "#131213", "cterm": "235"}
let s:medium_gray     = {"gui": "#ffffff", "cterm": "243"}
let s:cute_pink       = {"gui" : "#fccede", "cterm": "243"}
let s:cute_pink2       = {"gui" : "#f67099", "cterm": "243"}
let s:cute_pink3       = {"gui" : "#f4fccc", "cterm": "243"}
let s:cute_pink4       = {"gui" : "#fdf2f6", "cterm": "243"}
let s:white           = {"gui": "#ffffff", "cterm": "255"}
let s:white2           = {"gui": "#ffffff", "cterm": "255"}
let s:light_black     = {"gui": "#424242", "cterm": "238"}
let s:lighter_black   = {"gui": "#545454", "cterm": "240"}
let s:subtle_black    = {"gui": "#303030", "cterm": "236"}
let s:light_gray      = {"gui": "#ffffff", "cterm": "246"}
let s:lighter_gray    = {"gui": "#ffffff", "cterm": "252"}
let s:lightest_gray   = {"gui": "#ffffff", "cterm": "254"}
let s:yellow          = {"gui": "#ffffff", "cterm": "221"}
let s:mallow          = {"gui": "#d59412", "cterm": "221"}
"let s:mallow          = {"gui": "#d59412", "cterm": "221"}
"let s:mallow2          = {"gui": "#FED442", "cterm": "221"}
let s:mallow2          = {"gui": "#fa9ebc", "cterm": "221"}
let s:pink            = {"gui": "#ffffff", "cterm": "167"}
...
let g:pink_pony_club_bold = get(g:, 'pink_pony_club_bold', 1)
let g:pink_pony_club_italic = get(g:, 'pink_pony_club_italic', 1)
let s:bold = "bold"
let s:italic = "italic"

if (g:pink_pony_club_bold == 0 || &t_Co == 8 )
  let s:bold = "NONE"
endif

if (g:pink_pony_club_italic == 0)
  let s:italic = "NONE"
endif
...
call s:h("Cursor",        {"bg": s:mallow2, "fg": s:mallow2 })
call s:h("Comment",       {"fg": s:bg_subtle, "gui": s:italic})

call s:h("Constant",      {"fg": s:cute_pink})
call s:h("Numerical",      {"fg": s:cute_pink2})
hi! link Character        Constant
hi! link Number           Numerical
hi! link Boolean          Constant
hi! link Float            Constant
hi! link String           Constant

call s:h("Identifier",     {"fg": s:fg, "gui": s:bold})
hi! link Function         Identifier

call s:h("Statement",     {"fg": s:mallow2, "cterm": s:bold, "gui": s:bold})
...
call s:h("Type",          {"fg": s:mallow2})
hi! link StorageClass     Type
hi! link Structure        Type
hi! link Typedef          Type

call s:h("Special",       {"fg": s:cute_pink4, "gui": s:italic})
call s:h("DelimiterColor",       {"fg": s:cute_pink3, "gui": s:italic})
call s:h("TagColor",       {"fg": s:mallow2, "gui": s:italic})
hi! link SpecialChar      DelimiterColor
hi! link Tag              TagColor
...
call s:h("htmlH6", { "fg": s:fg, "gui": s:bold, "cterm": s:bold })
call s:h("htmlLink", { "fg": s:fg, "gui": s:bold, "cterm": s:bold })
...
highlight Search guifg=#000000 guibg=#a8a6af
